...
<div id="accountSetting" style="display:none">
    <div class="ggzdl_accountSetupWrap">
        <div class="ggzdl_accountSetupBrief" :class="{on:passwordShow}"  @click="tabSwitch('changePassword')">
            密码设置<i class="ggzdl_accountSetupRight"></i>
        </div>
        <div class="ggzdl_accountSetupPwd" v-show="passwordShow">
            <div class="ggzdl_accountSetupPwdWrap" style="position: relative">
                <input type="password" placeholder="请输入原始密码" v-model="oldpas" @blur="checkErrPwd">
                <span  class="pgy_fogetPwd" style="color: rgb(255, 114, 65);">@{{testPwd.errPwd}}</span>
                <input type="password" placeholder="请输入新密码" v-model="newpas" @blur="checkErrNewPwd">
                <span  style="color: rgb(255, 114, 65); position: absolute;left:11px;top:117px;font-size: 12px;">@{{testPwd.errNewPwd}}</span>
                <input type="password" placeholder="再次输入密码" v-model="newpas2" @blur="checkErrNewPwd2">
                <span  style="color: rgb(255, 114, 65);position: absolute;left:11px;top:186px;font-size: 12px;">@{{testPwd.errConfirmPwd}}</span>
                <input type="button" @click="changePwd" value="确  定" style="font-size:18px">
            </div>
        </div>
    </div>
    ...
    <div class="ggzdl_accountSetupWrap">
        <div class="ggzdl_accountSetupBrief" :class="{on:bankShow}" @click="tabSwitch('bindBank')">
            银行卡设置<i class="ggzdl_accountSetupRight"></i>
        </div>
        
        <!--绑定银行卡-->
        <div class="ggzdl_accountSetupBank" v-show="bankShow">

            <div v-if="accountBank.bankStatus==='noBindBank'" class="ggzdl_accountSetupBankWrap" style="margin-top:50px;">
                <input type="text" style=" margin:0;" placeholder="请输入你的真实姓名" v-model="bindBankObj.bind_realname" @blur="checkName">
                <div style=" font-size:12px; color:#FF7241; height:30px; line-height:30px; padding:0 10px;">@{{errName}}</div>
                <input type="text" style=" margin:0;" placeholder="请输入身份证号码" v-model="bindBankObj.bind_idnumber" @blur="checkIdentity">
                ...
                <input type="text" style=" margin:0;" placeholder="请输入银行卡号"  v-model="bindBankObj.bind_banknumber" @blur="luhnCheck">
                <div style=" font-size:12px; color:#FF7241; height:30px; line-height:30px; padding:0 10px;">@{{errCard}}</div>
                <input type="text" style=" margin:0;" placeholder="请输入银行预留手机号" v-model="bindBankObj.bind_mobile" @blur="checkMobile">
                <div style=" font-size:12px; color:#FF7241; height:30px; line-height:30px; padding:0 10px;">@{{errMobile}}</div>
                <input @click="bindBankName" type="button" value="绑  定" style="font-size:18px">
            </div>
             <!--解绑更换银行卡-->
            <div v-if="accountBank.bankStatus==='bindBank'" class="ggzdl_accountSetupBank" >
                <div class="zmtdl_accountSetupBankInfoWrap">
                    <div class="zmtdl_accountSetupBankBind">
                        ...
                        <span class="zmtdl_accountSetupBankNum">****&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@{{banknumber|bankFormat}}</span>
                        <span class="zmtdl_accountSetupBankUser">持卡人：@{{realname}}**</span>
                    </div>
        ...
        <!--更换银行卡手机号-->
            <div v-if="accountBank.bankStatus==='changeBank'" class="ggzdl_accountSetupBank" >
                <div class="zmtdl_accountSetupBankRelieveChangeWrap">
                    <div class="zmtdl_accountSetupBank_mobile">
                        ...
                        <div style="margin: 40px 0;">
                            ...
                            <input class="zmtdl_accountSetupBank_codebtn" type="button" @click="sendMsg" value="发送验证码" :disabled="disabled" v-model="validCode">
                        </div>
                        <div>
        ...
        <!-- 解绑银行卡手机号 -->
            <div v-if="accountBank.bankStatus==='unbindBank'" class="ggzdl_accountSetupBank" >
                <div class="zmtdl_accountSetupBankRelieveChangeWrap">
                    <div class="zmtdl_accountSetupBank_mobile">
                        <div><span>手机号</span>&nbsp;&nbsp;&nbsp;@{{mobile|mobileFormat}}</div>
                        <div style="margin: 40px 0;">
        ...
        <!--银行卡解绑成功-->
            <div  v-if="accountBank.bankStatus==='unbindBankSuccess'" class="ggzdl_accountSetupBank" >
                <div class="zmtdl_bankRelieveSuccessWrap">
    ...
    <div class="ggzdl_accountSetupWrap">
        <div class="ggzdl_accountSetupBrief" :class="{on:renzShow}"  @click="tabSwitch('changeRenz')">
            实名认证<i class="ggzdl_accountSetupRight"></i>
        </div>
        <div class="ggzdl_accountSetupPwd "  v-show="renzShow" >
            <div class="ggzdl_accountSetupPwdWrapbd" id="ggzdl_accountSetupPwdWrap" style="position:relative;" v-show="!checked">
                ...
                <input type="button" @click="renzSubmit" value="提  交" id="pgyti" style="margin-top: 30px;font-size:18px">
            </div>
            ...
            <div class="ggzdl_accountSetupPwd" v-show="checked">
                <div class="ggzdl_accountSetupPwdWrap">
                    <div class="pgy_success_g">
                        <img src="/image/pgy_renz_success.jpg" alt="">
         ...
         var app = new Vue({
                ...
                methods:{
                    ...
                    bindBankName:function(){//绑定银行卡
                        var _this=this;
                        if( this.checkName() && this.checkIdentity() && this.checkBankName() && this.luhnCheck() && this.checkMobile() ){
                            $.ajax({
