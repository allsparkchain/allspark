...
<div class="warp">
    <header>
        <div class="header_content">
            ...
            <div class="login" onclick="window.location='/'"><img src="/images/userLogo.png"></div>
        </div>
    </header>
    ...
    <footer>
        <p style="margin-top: 100px;text-align: center;">©2017 剑指网络 ALL RIGHTS RESERVED. <a  href="http://www.miitbeian.gov.cn" target="_blank" style="text-decoration: none; color: black;">沪ICP备16017440号</a>　</p>
    </footer>
</div>
