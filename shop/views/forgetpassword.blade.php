    ...
    <link rel="stylesheet" href="{{ mix('css/password.css') }}">
        ...
        <div class="content_from">
            ...
            <div class="user_messgin">
                ...
                <span id="userNameT" class="userNameT"  style="display: none;">请输入正确的电话号码</span>
                <div class="mgint_T">

                    <i class="yancode"></i>
                    <input id="userPassword" type="text" maxlength="6" class="inputstyle password" placeholder="输入验证码">
