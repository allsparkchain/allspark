...
@section("content")
        ...
        <div class="content_from">
            ...
            <div class="user_messgin" id="user_messgin">
                ...
                <div style="margin-top: 20px">
                    ...
                    <i class="pUser"></i>
                    <input id="code" type="text" name="code" class="inputstyle password" placeholder="输入验证码" maxlength="6">
                </div>
    ...
    <div class="content_chckbox">
        ...
        <input type="checkbox" id="unChecked"  name="unChecked" style="margin-top: 6px;float: left;">
