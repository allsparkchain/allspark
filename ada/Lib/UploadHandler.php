...
class UploadHandler
{
    ...
    protected $uploadType = [
        0 => [
            ...
            'accept_file_types' => '/\.(txt|doc|docx|xls|xlsx|ppt|pptx|pdf)$/i',
        ],
        1 => [
            'readfile_chunk_size' => 5 * 1024 * 1024,
            'accept_file_types' => '/\.(gif|jpe?g|png)$/i',
        ],
        2 => [
            'readfile_chunk_size' => 50 * 1024 * 1024,
            'accept_file_types' => '/\.(mp4|swf|flv|avi|rmvb|rm|asf|divx|mpg|mpeg|mpe|wmv|mkv|vob)$/i',
        ],
    ];


    public function __construct($type = 0, $options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            ...
            'readfile_chunk_size' => $this->uploadType[$type]['readfile_chunk_size'], // 10 MiB
            // Defines which files can be displayed inline when downloaded:
            'inline_file_types' => '/\.(gif|jpe?g|png)$/i',
            // Defines which files (based on their names) are accepted for upload:
            'accept_file_types' => $this->uploadType[$type]['accept_file_types'],
